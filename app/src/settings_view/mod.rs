...
pub fn create_discount_badge(discount: u32, appearance: &Appearance) -> Box<dyn Element> {
    ...
    .with_background(internal_colors::neutral_2(appearance.theme()))
    .finish()
}
...
impl Display for SettingsSection {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            SettingsSection::Account => write!(f, "General"),
...
impl SettingsSection {
    pub fn warp_lite_replacement(self) -> Self {
        match self {
            Self::MCPServers
            ...
            | Self::OzCloudAPIKeys => Self::Account,
            other => other,
        }
    }
...
impl FromStr for SettingsSection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "About" => Ok(Self::About),
            "Account" | "General" => Ok(Self::Account),
            "AI" => Ok(Self::AI),
...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let features_page_handle =
            ctx.add_typed_action_view(|ctx| FeaturesPageView::new(global_resource_handles, ctx));
        ...
        let initial_page = page
            .map(SettingsSection::warp_lite_replacement)
            .unwrap_or_default();
    ...
    pub fn set_and_refresh_current_page_internal(
        ...
        let section = section.warp_lite_replacement();
    ...
    pub fn open_mcp_servers_page(
        ...
        let _ = (page, autoinstall_gallery_title);
        self.set_and_refresh_current_page(SettingsSection::Account, ctx);
    }
